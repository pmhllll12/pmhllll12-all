...
import pytest
from admin.adapter.outbound.mapper.piper_bighetti_hr_mapper import (
    bighetti_hr_default_entity,
)
from admin.adapter.outbound.mapper.piper_dinesh_dash_mapper import (
    dinesh_dash_default_entity,
)
from admin.adapter.outbound.mapper.piper_dunn_coo_mapper import (
    dunn_coo_default_entity,
)
from admin.adapter.outbound.mapper.piper_gilfoyle_system_mapper import (
    gilfoyle_system_default_entity,
)
from admin.adapter.outbound.mapper.piper_hendricks_ceo_mapper import (
